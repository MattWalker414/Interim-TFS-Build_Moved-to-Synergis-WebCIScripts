...
Robocopy $from $to /S /IS /Purge /xf appsettings.config connections.config iisstart.htm welcome.png indexprismdocs.html site_prismdocs.min.css /xd Dynamic aspnet_client jvue AdeptClientServices AdeptTaskPane Downloads
